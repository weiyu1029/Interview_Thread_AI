...
InterviewThread borrows product patterns, not code, from established open-source
career tools. Every upstream license still applies to any code or asset that a
future contributor may intentionally reuse.

| Project | Pattern worth learning from | InterviewThread application |
|---|---|---|
...
## What InterviewThread should differentiate
...
and trust risks. InterviewThread should instead make the candidate's evidence easier
