      ...
      <section className="workspace" id="workspace">
        ...
        <div className="workspace-main">
          {active === "Analyze" && <>
            ...
            <div className="action-row"><div><label htmlFor="model">AI model</label><select id="model" value={provider} onChange={(event) => setProvider(event.target.value)}>{PROVIDERS.map((item) => <option key={item}>{item}</option>)}</select></div><button className="button primary" onClick={analyze}>Run evidence match</button></div>
