  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Voice input uses browser speech capabilities when available. InterviewThread does not store raw voice audio, but the browser, operating system, or speech-recognition provider may process audio under its own policy. You can edit recognized text before submitting an answer.",
