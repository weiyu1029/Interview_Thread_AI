  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "We use service providers needed to operate the site, including Cloudflare infrastructure and D1, the identity provider you choose, and a transactional email provider for contact-form delivery. Data also goes to an external endpoint only when you select a feature that requires it. We do not sell personal data, build advertising profiles, share career evidence with employers, or use the service to make employment decisions.",
        ],
      },
      {
