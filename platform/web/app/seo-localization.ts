...
const REVIEWED_UI: Partial<Record<LocaleCode, SeoUiCopy>> = {
  ...
  ko: {
    ...
    whyBrand: "CareerStoryMap을 선택하는 이유",
  ...
  es: {
    ...
    whyBrand: "Por qué CareerStoryMap",
    ...
    openProduct: "Abrir CareerStoryMap",
  ...
  fr: {
    ...
    whyBrand: "Pourquoi CareerStoryMap",
    ...
    openProduct: "Ouvrir CareerStoryMap",
  ...
  de: {
    ...
    openProduct: "CareerStoryMap öffnen",
...
const EN_UI: SeoUiCopy = {
  ...
  openProduct: "Open CareerStoryMap",
  repository: "Open-source repository",
};
...
export function seoUiFor(locale: LocaleCode): SeoUiCopy {
  ...
  return {
    ...
    whyBrand: `CareerStoryMap · ${core.analyze}`,
...
export function localizedSeoPage(
  ...
  return {
    ...
    faqs: [
      ...
      { question: `CareerStoryMap · ${core.analyze}`, answer: core.heroBody },
    ],
